						...
						<Popover.Positioner side="top" sideOffset={8} positionMethod="fixed">
							<Popover.Popup
								className={cn(
									...
									// 'origin-(--transform-origin) transition-all duration-200 will-change-transform',
									// 'ease-[cubic-bezier(0.175,0.885,0.32,1.075)] lg:ease-[cubic-bezer(0.175,0.885,0.32,1.1)]',
									'popup-transition',
							...
							>
								...
								>
									<img
										...
										className={
											'aspect-4/3 w-[calc(100%-8px)] shrink-0 snap-start snap-always rounded-xs object-cover select-none'
										}
									/>
									<img
										src={scheveningen1}
										...
										className={
											'aspect-4/3 w-[calc(100%-8px)] shrink-0 snap-center snap-always rounded-xs object-cover object-[center_calc(50%-10px)] select-none'
										}
									/>
									<img
										src={scheveningen3}
										...
										className={
											'aspect-4/3 w-[calc(100%-8px)] shrink-0 snap-end snap-always rounded-xs object-cover select-none'
										}
									/>
								</div>

...
export function Links() {
	return (
		<ul className={'flex flex-col pt-6 pb-4'}>
			{LinksData.map(({ icon: Icon, label, url }) => (
				<li>
					<a
						...
						className={cn(
							'group relative flex items-center gap-4 px-6 py-2.5',
							'transition-transform will-change-transform active:scale-99',
							'outline-none',

							'before:pointer-events-none before:absolute before:inset-x-3 before:inset-y-0 before:-z-1 before:rounded-[3px]',

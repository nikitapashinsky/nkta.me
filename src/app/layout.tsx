...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={
          "bg-white font-sans text-base font-450 text-primary antialiased"
        }
      >
        <div
          className={twJoin(
        ...
        >
          ...
          >
            <div className={"flex h-(--top-offset) shrink-0 flex-col"}>
              ...
              <p
                className={
                  "text-secondary will-change-transform animation-delay-150"
                }
              >
                Interface designer
              </p>
            ...
            <div
              className={
                "flex flex-1 flex-col justify-between gap-6 max-md:hidden"
              }
            >
              <Nav />
